...
public class Main {
    public static void main(String[] args) throws IOException {
        ...
        //AirportReport.create_saveCh(airport, airport.getName());
        //System.out.println(AirportReport.readReportCh(airport.getName()));
        AirportReport.create_saveB(airport, airport.getName());
        System.out.println(AirportReport.readReportB(airport.getName()));
    }
